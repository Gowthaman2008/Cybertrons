# 🛡️ ScamCheck — Scam Forensics Lab

```
================================================================================
🏆 HACKATHON  : Hackspora 2.0
👥 TEAM NAME  : Cybertrons
🆔 TEAM ID    : HS2026-086
================================================================================
```

| 👥 **Team Name** | 🆔 **Team ID** | 🏆 **Hackathon** | 🌐 **Live Demo** |
| :---: | :---: | :---: | :---: |
| **`Cybertrons`** | **`HS2026-086`** | **Hackspora 2.0** | [cybertrons.vercel.app](https://cybertrons.vercel.app) |
